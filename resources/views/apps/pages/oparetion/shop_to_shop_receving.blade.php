...
@section('title','Shop to Shop Receving')
@section('breadcrumb','Shop to Shop Receving')
@section('breadcrumb_page','Shop to Shop Receving')
@section('content')
<div class="content">
	 <div class="container">
	    <div class="row">
          ...
          @include('apps.include.msg')
           <div class="col-md-5" >
	            <fieldset class="scheduler-border">
	              <legend class="scheduler-border">Shop to Shop Receving info:</legend>
                          <div class="table-responsive" >
                            <form enctype="multipart/form-data" method="post" 
                    
                              @if(!empty($data))
                                action="{{url('shop_to_shop_receving-update/'.$data->id)}}"
                              @else
                              action="{{url('shop_to_shop_receving-add')}}"
                              @endif
                              >
                              {{ csrf_field() }}
                  ...
                  <div class="col-md-7">
                    <fieldset class="scheduler-border">
                <legend class="scheduler-border">Shop to Shop Receving List:</legend>
                          <div class="table-responsive" >
                              ...
                              <table id="tableData" class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$row->quantity}}</td>
                                       <td>
                                          <a href="{{url('shop_to_shop_receving/edit/'.$row->id)}}" class="btn btn-sm btn-outline-info"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                          <a href="{{url('shop_to_shop_receving/delete/'.$row->id)}}" class="btn btn-sm btn-outline-danger"><i class="fa fa-times" aria-hidden="true"></i></a>
                                       </td>
                                    </tr>
                                    @endforeach
                                    @endif
