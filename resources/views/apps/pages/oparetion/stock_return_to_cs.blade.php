...
@section('title','Stock Return To CS')
@section('breadcrumb','Stock Return To CS')
@section('breadcrumb_page','Stock Return To CS')
@section('content')
<div class="content">
	 <div class="container">
	    <div class="row">
          ...
          @include('apps.include.msg')
           <div class="col-md-5" >
	            <fieldset class="scheduler-border">
	              <legend class="scheduler-border">Stock Return To CS info:</legend>
                          <div class="table-responsive" >
                            <form enctype="multipart/form-data" method="post" 
                    
                              @if(!empty($data))
                                action="{{url('stock_return_to_cs-update/'.$data->id)}}"
                              @else
                              action="{{url('stock_return_to_cs-add')}}"
                              @endif
                              >
                              {{ csrf_field() }}
                  ...
                  <div class="col-md-7">
                    <fieldset class="scheduler-border">
                <legend class="scheduler-border">Stock Return To CS List:</legend>
                          <div class="table-responsive" >
                              ...
                              <table id="tableData" class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$row->quantity}}</td>
                                       <td>
                                          <a href="{{url('stock_return_to_cs/edit/'.$row->id)}}" class="btn btn-sm btn-outline-info"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                          <a href="{{url('stock_return_to_cs/delete/'.$row->id)}}" class="btn btn-sm btn-outline-danger"><i class="fa fa-times" aria-hidden="true"></i></a>
                                       </td>
                                    </tr>
                                    @endforeach
                                    @endif
